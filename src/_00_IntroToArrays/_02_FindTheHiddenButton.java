...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String number = JOptionPane.showInputDialog("Enter a positive whole number.");
		...
		JOptionPane.showMessageDialog(null, "Find the hidden button and click on it.");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==buttons[hiddenButton]) {
			JOptionPane.showMessageDialog(null, "u are gud");
		}
